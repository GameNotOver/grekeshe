...
public class CodeGenerator {
    ...
    static {
        // 必填
        ds.setUrl("jdbc:mysql://localhost:3306/keshe?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=false&serverTimezone=GMT%2b8");
        ds.setUsername("keshe");
        ds.setPassword("123456");
    }

    private static final String schemaName = "test";   // 数据库名称，必填
    private static final String[][] tables = {{"pv_system", "Pv_system"}};   // 必填
